...
export const followQuestion = (qid) => post(API_QUES_FOLLOW + `?uid=${getUser().uid}&qid=${qid}`, {}, true);

export const unfollowQuestion = (qid) => post(API_QUES_UNFOLLOW + `?uid=${getUser().uid}&qid=${qid}`, {}, true);
